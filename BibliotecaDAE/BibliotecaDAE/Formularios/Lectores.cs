...
namespace Biblioteca
{
    public class FrmLectores : Form
    {
        ...
        // Controles NUEVOS para el CRUD de Lector
        ...
        private async Task LoadLectoresAsync()
        {
            ...
            try
            {
                ...
                // Ocultar/Ajustar columnas para 'Lector'
